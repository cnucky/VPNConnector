...
import org.togacure.vpnconnector.ConfigurableVpnService;
...
public class UDPOutput implements Runnable
{
    ...
    private ConfigurableVpnService vpnService;
    ...
    public UDPOutput(ConcurrentLinkedQueue<Packet> inputQueue, Selector selector, ConfigurableVpnService vpnService)
    {
